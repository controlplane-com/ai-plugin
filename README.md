...
Codex plugin metadata is in `.codex-plugin/plugin.json`, the Codex MCP bundle is in `.codex-plugin/mcp.json`, and the Codex marketplace entry is in `.agents/plugins/marketplace.json`.
