 ...
 *
 * The manifest is generated by the MCP server repo — regenerate after tool changes:
 *   (in controlplane/mcp/server) node evals/export-tool-manifest.mjs > ../../../ai-plugin/scripts/tools-manifest.json
 *
